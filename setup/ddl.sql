...
*
*************************************************************/
CREATE OR REPLACE SCHEMA DEV_DIGITAL_DROPS.CONTROL WITH MANAGED ACCESS;
...
*
*************************************************************/
CREATE OR REPLACE SCHEMA DEV_DIGITAL_DROPS.STAGING WITH MANAGED ACCESS;
...
*
*************************************************************/
CREATE OR REPLACE SCHEMA DEV_DIGITAL_DROPS.MODEL WITH MANAGED ACCESS;
...
CREATE OR REPLACE SEQUENCE DEV_DIGITAL_DROPS.MODEL.ALBUM_SK START 1 INCREMENT 1;

CREATE OR REPLACE TABLE DEV_DIGITAL_DROPS.MODEL.ALBUM
(
    ALBUM_SK                  NUMBER(38, 0) DEFAULT DEV_DIGITAL_DROPS.MODEL.ALBUM_SK.NEXTVAL                  NOT NULL,
    ALBUM_ARTIST_ID           NUMBER(38, 0),
    ALBUM_ARTIST_NAME         VARCHAR,
    ALBUM_ARTIST_URL          VARCHAR,
    ALBUM_ARTWORK_URL_100     VARCHAR,
    ALBUM_COPYRIGHT           VARCHAR,
    ALBUM_GENRES              VARIANT,
    ALBUM_ID                  NUMBER(38, 0),
    ALBUM_KIND                VARCHAR,
    ALBUM_NAME                VARCHAR,
    ALBUM_RELEASE_DATE        TIMESTAMP_NTZ,
    ALBUM_URL                 VARCHAR,
...
/*************************************************************
*
*	DDL: PRESENTATION VIEWS
*
*************************************************************/
CREATE OR REPLACE SCHEMA DEV_DIGITAL_DROPS.PRESENTATION WITH MANAGED ACCESS;

CREATE OR REPLACE VIEW DEV_DIGITAL_DROPS.PRESENTATION.MEDIA AS
    SELECT NULL TYPE
         , NULL NAME
         , NULL MADE_BY
         , NULL INFO
    ...
    FROM DEV_DIGITAL_DROPS.MODEL.FILM
    UNION ALL
    SELECT 'GAME'
         , GAME_NAME
         , NULL
         , GAME_SUMMARY
         , GAME_FIRST_RELEASE_DATE::DATE
    FROM DEV_DIGITAL_DROPS.MODEL.GAME
    WHERE GAME_FIRST_RELEASE_DATE >= CURRENT_DATE
    UNION ALL
    SELECT 'ALBUM'
         , ALBUM_NAME
         , ALBUM_ARTIST_NAME
    ...
    FROM DEV_DIGITAL_DROPS.MODEL.ALBUM
    ORDER BY DATE;
/*************************************************************
*
*	DCL: SECURITY
